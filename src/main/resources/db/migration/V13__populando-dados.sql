...
INSERT INTO animais (nome, especie, vacina, sexo, cor, data_nascimento, descricao, raca, peso, foto, ativo, clientes_id) VALUES
    ...
    ('Mia', 'Gato', 'Polivalente', 'Fêmea', 'Branco', '2019-05-23', 'Gato de porte médio, muito carinhosa e independente.', 'Siamês', '4kg', 'https://res.cloudinary.com/dfgbasaxa/image/upload/v1734376537/emj9ilokueoh9kaobqqb.webp', 1, 2),
    ...
    ('Bella', 'Cão', 'Raiva, Polivalente', 'Fêmea', 'Branca', '2021-12-01', 'Cachorra muito ativa e dócil, ótima para famílias.', 'Labrador', '25kg', 'https://res.cloudinary.com/dfgbasaxa/image/upload/v1734376537/geubvdcdltpoj8spthtd.webp', 1, 4),
    ('Simba', 'Gato', 'Raiva, Polivalente', 'Macho', 'Dourado', '2020-03-10', 'Gato grande, muito brincalhão e curioso.', 'Persa', '7kg', 'https://res.cloudinary.com/dfgbasaxa/image/upload/v1734376537/j6st9mqljpg8vbzvqgpk.webp', 1, 5),
    ...
    ('Zeus', 'Cão', 'Raiva, Polivalente', 'Macho', 'Branco', '2018-10-05', 'Cachorro forte e protetor, muito leal ao dono.', 'Rottweiler', '40kg', 'https://res.cloudinary.com/dfgbasaxa/image/upload/v1734376537/ia5ur30plxq70k95kj2m.webp', 1, 7),
    ('Lola', 'Gato', 'Raiva, Polivalente', 'Fêmea', 'Preto', '2020-06-13', 'Gato muito tranquilo e afetuoso.', 'Maine Coon', '5kg', 'https://res.cloudinary.com/dfgbasaxa/image/upload/v1734376537/vqdefigucycg0tizfgnn.webp', 1, 8),
    ('Fiona', 'Cão', 'Raiva, Polivalente', 'Fêmea', 'Branca e Marrom', '2021-01-27', 'Cachorra de pequeno porte, muito amorosa.', 'Beagle', '10kg', 'https://res.cloudinary.com/dfgbasaxa/image/upload/v1734376537/b36eqdoeugexfdvvesks.webp', 1, 9),
